export const DRUGS={
 verapamil:{name:'Verapamil',duration:60000,description:'A case-specific response for the authored fascicular VT; also slows AV nodal conduction in this teaching model.',limit:'Not a treatment rule for undifferentiated wide-complex tachycardia. Hemodynamic deterioration and contraindications are not simulated.'},
 adenosine:{name:'Adenosine',duration:8000,description:'Transient AV nodal block. Can interrupt AVNRT / orthodromic AVRT. The foundational AT continues; the adenosine-sensitive AT and RVOT teaching cases terminate.',limit:'Drug termination alone does not establish the mechanism. Sinus-node effects, bronchospasm and pre-excited AF are not modeled.'},
